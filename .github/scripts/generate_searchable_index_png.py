...
<div style="font-family: sans-serif; max-width: 800px; margin: 2em auto; padding: 1em; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9;">
    ...
    <p>
      ...
      This page presents a curated subset of modules from the <a href="https://github.com/ying-ge/FigureYa/" target="_blank">FigureYa</a> project that can be run and browsed online using GitHub Actions, without requiring any local data dependencies. It is not the full FigureYa suite, but a selection made available for immediate online exploration and demonstration.
    </p>
    <p>
      Welcome! This page provides a searchable interface for all reports and figures generated by the <strong>FigureYa</strong> project. It's designed to help you quickly find and explore the results from our manuscript.
    </p>
    <hr>
